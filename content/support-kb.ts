...
- Apple handles every payment and refund. When a question touches a refund, say Apple handles it and point to reportaproblem.apple.com.
- Never say Courier is available now, can be bought now or is in the app today. It arrives in an update after release.
