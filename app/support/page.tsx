...
export const metadata: Metadata = {
  ...
  description: "email us or send a message from this page. a small team reads everything and answers within a day, usually faster. questions, bugs, a wrong price.",
