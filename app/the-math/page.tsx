...
const SECTIONS: [string, string][] = [
  ...
  ["A solver, not a guess", "The week is solved by a deterministic solver: the same numbers in always give the same week out, and it cannot get arithmetic wrong. It picks one short list of staples that overlap across five days so that every pack gets finished. Perishables go early in the week, freezer-friendly meals by Friday."],
  ...
  ["What we refuse", "Fake reviews. Sponsored picks in your list. Hidden delivery markups. When we show what the same list costs delivered, it is an estimate and sits next to the shelf price with fees included."],
];
