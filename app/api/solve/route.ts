...
export async function POST(req: Request) {
  ...
  if (budget === null || protein_per_day === null || kcal_min === null || kcal_max === null || household === null || diet === null || kcal_min > kcal_max) {
    return Response.json(
      { error: "expected budget 1-1000, protein_per_day 1-400, kcal_min <= kcal_max in 500-6000, household 1-8, diet one of " + DIETS.join("|") },
      { status: 400 },
    );
  }
