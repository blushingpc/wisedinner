  ...
  return (
    <main id="main">
      <Section className="grid gap-12 lg:grid-cols-[1.2fr_1fr]">
        <div>
          <p className="tnum text-xs uppercase text-forest">press</p>
          <h1 className="mt-4 text-h1 font-bold">press kit.</h1>
          <h2 className="mt-10 tnum text-xs uppercase text-ink-2">boilerplate</h2>
          <p className="mt-3 max-w-[62ch] text-xl">{PRESS_BOILERPLATE}</p>
          <h2 className="mt-10 tnum text-xs uppercase text-ink-2">contact</h2>
          <p className="mt-3">
            <a href={`mailto:${SUPPORT_EMAIL}`} className="text-link">
              {SUPPORT_EMAIL}
            </a>
          </p>
          <h2 className="mt-10 tnum text-xs uppercase text-ink-2">downloads</h2>
