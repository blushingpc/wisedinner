...
import { PRIVACY_EFFECTIVE, PURCHASES } from "@/content/legal";
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>Effective: {PRIVACY_EFFECTIVE}</p>
      </>
    ),
  },
];
...
export default function Privacy() {
  return <LegalLayout title="Privacy policy" effective={PRIVACY_EFFECTIVE} sections={S} />;
}
