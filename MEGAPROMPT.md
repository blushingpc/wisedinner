...
2. Before any code: keep-it-simple skill. Before any UI commit: `/impeccable audit`. Before any product/pricing decision: CLAUDE.md "External rules" + pricing honesty.
